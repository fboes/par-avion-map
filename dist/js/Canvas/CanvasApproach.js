...
export default class CanvasApproach {
    ...
    makeRunways() {
        ...
        this.airport.runways.forEach((runway) => {
            ...
            t.fillRect(runway.length / CanvasApproach.FACTOR / -2, runway.width / CanvasApproach.FACTOR / -2, runway.length / CanvasApproach.FACTOR, runway.width / CanvasApproach.FACTOR);
            [0, 1].forEach((i) => {
                t.textStyle(4);
