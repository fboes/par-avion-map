...
export default class Navaid extends Point {
    constructor(coordinates, randomizer, type = "") {
        ...
        switch (this.type) {
            ...
            case Navaid.ILS:
                this.frequency =
                    this.randomizer.getInt(108, 111) +
                        this.randomizer.getInt(0, 4) * 0.2 +
                        0.1;
                this.range = 50;
                break;
    ...
    randHoldingPattern(degree = null) {
        ...
        this.isSwitchLabelPosition =
            this.holdingPattern !== null &&
                this.holdingPattern.direction !== null &&
                ((this.holdingPattern.isRight &&
                    (this.holdingPattern.direction.degree < 100 ||
                        this.holdingPattern.direction.degree > 300)) ||
                    (!this.holdingPattern.isRight &&
                        (this.holdingPattern.direction.degree < 60 ||
                            this.holdingPattern.direction.degree > 260)));
    }
}
Navaid.VOR = "VOR";
Navaid.NDB = "NDB";
